...
const BaseInput = ({ title, required = true, readonly, type, formatInput, width = "w-1/5", labelColor = "text-black", name }) => {
    ...
    return (
        <div className={width}>
            ...
            <input
                ...
                value={inputValue} // Correctly sets the formatted value
                name={name}
                onChange={handleInputChange} // Applies formatting on each change
                required={required}
                readOnly={readonly}
            />
        </div>
