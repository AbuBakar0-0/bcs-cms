...
function ProvidersInformation() {
  ...
  const handleSubmit = async () => {
    ...
    try {
      const jsonBody = { ...formData, added_by: addedBy };

      const response = await axios.post("/api/providers-info", jsonBody, {
        headers: {
          "Content-Type": "application/json",
        },
      });

      // Assuming the response contains the message and provider_id
  ...
  // Inside your ProvidersInformation component
  useEffect(() => {
