...
const ProfessionalIds = () => {
  ...
  const renderPortalCredentials = (prefix, title, link) => (
    <div className={`${prefix==='other' || prefix==='caqh'?"w-[99%]":"w-[49%]"} flex flex-wrap justify-start gap-4 items-end`}>
      {prefix === "caqh" && (
        <TextInput
          title="CAQH User Id"
          width="w-[22%]"
...
{prefix === "other" && (
      ...
      {/* {prefix !== "caqh" && (
        ...
        //     <TextInput title={"Security Question 1"} />
        //     <TextInput title={"Security Answer 1"} />
        //     <TextInput title={"Security Question 2"} />
        //     <TextInput title={"Security Answer 2"} />
        //     <TextInput title={"Security Question 3"} />
        //     <TextInput title={"Security Answer 3"} />
        //   </div>
        // </>
      )} */}
    </div>
